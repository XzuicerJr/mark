...
>(({ className, size = "default", ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "bg-background pointer-events-none block h-4 w-4 rounded-full shadow-lg ring-0 transition-all data-[state=checked]:translate-x-4 data-[state=unchecked]:translate-x-0",
        size === "small" && "h-3 w-3 data-[state=checked]:translate-x-5",
      )}
    />
  </SwitchPrimitives.Root>
));
